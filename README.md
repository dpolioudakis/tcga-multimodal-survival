...
Next steps
- Check clinical preprocessing for
  - Following RNA preprocessing format
  - Update test preprocessing module cell
  - Update module to output run metadata as JSON
  - Some 'parameters' may not actually be parameters - confirm clean split between notebook and module
